...
public class KaoshitongjiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,KaoshitongjiEntity kaoshitongji, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,KaoshitongjiEntity kaoshitongji, HttpServletRequest request){
        EntityWrapper<KaoshitongjiEntity> ew = new EntityWrapper<KaoshitongjiEntity>();
		PageUtils page = kaoshitongjiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, kaoshitongji), params), params));
        return R.ok().put("data", page);
    }
