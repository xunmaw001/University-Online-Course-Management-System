...
public class KetangqiandaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,KetangqiandaoEntity ketangqiandao, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("jiaoshi")) {
			ketangqiandao.setGonghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,KetangqiandaoEntity ketangqiandao, HttpServletRequest request){
        EntityWrapper<KetangqiandaoEntity> ew = new EntityWrapper<KetangqiandaoEntity>();
		PageUtils page = ketangqiandaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, ketangqiandao), params), params));
        return R.ok().put("data", page);
    }
