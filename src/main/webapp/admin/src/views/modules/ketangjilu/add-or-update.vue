          ...
          <el-form-item class="input" label="科目名称" prop="kemumingcheng">
              <el-input v-model="ruleForm.kemumingcheng" 
                placeholder="科目名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学生人数" prop="xueshengrenshu">
          <el-input v-model="ruleForm.xueshengrenshu" 
              placeholder="学生人数" clearable  :readonly="ro.xueshengrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学生人数" prop="xueshengrenshu">
              <el-input v-model="ruleForm.xueshengrenshu" 
                placeholder="学生人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="视音频链接" prop="shiyinpinlianjie">
          <el-input v-model="ruleForm.shiyinpinlianjie" 
              placeholder="视音频链接" clearable  :readonly="ro.shiyinpinlianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="视音频链接" prop="shiyinpinlianjie">
              <el-input v-model="ruleForm.shiyinpinlianjie" 
                placeholder="视音频链接" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="缺课原因" prop="quekeyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="缺课原因"
                  v-model="ruleForm.quekeyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.quekeyuanyin" label="缺课原因" prop="quekeyuanyin">
                    <span>{{ruleForm.quekeyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="作业布置" prop="zuoyebuzhi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="作业布置"
                  v-model="ruleForm.zuoyebuzhi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuoyebuzhi" label="作业布置" prop="zuoyebuzhi">
                    <span>{{ruleForm.zuoyebuzhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      ro:{
	kemumingcheng : false,
	xueshengrenshu : false,
	quekeyuanyin : false,
	zuoyebuzhi : false,
	shiyinpinlianjie : false,
	riqi : false,
	gonghao : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kemumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='xueshengrenshu'){
            this.ruleForm.xueshengrenshu = obj[o];
	    this.ro.xueshengrenshu = true;
            continue;
          }
	            	            if(o=='quekeyuanyin'){
            this.ruleForm.quekeyuanyin = obj[o];
	    this.ro.quekeyuanyin = true;
            continue;
          }
	            	            if(o=='zuoyebuzhi'){
            this.ruleForm.zuoyebuzhi = obj[o];
	    this.ro.zuoyebuzhi = true;
            continue;
          }
	            	            if(o=='shiyinpinlianjie'){
            this.ruleForm.shiyinpinlianjie = obj[o];
	    this.ro.shiyinpinlianjie = true;
            continue;
          }
	            	            if(o=='riqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ketangjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ketangjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
