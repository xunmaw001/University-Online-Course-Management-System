          ...
          <el-form-item class="input" label="上课时间" prop="shangkeshijian">
              <el-input v-model="ruleForm.shangkeshijian" 
                placeholder="上课时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="视频连接" prop="shipinlianjie">
          <el-input v-model="ruleForm.shipinlianjie" 
              placeholder="视频连接" clearable  :readonly="ro.shipinlianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="视频连接" prop="shipinlianjie">
              <el-input v-model="ruleForm.shipinlianjie" 
                placeholder="视频连接" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangkeshijian = true;
            continue;
	            	            ...
	            	            if(o=='shipinlianjie'){
            this.ruleForm.shipinlianjie = obj[o];
	    this.ro.shipinlianjie = true;
            continue;
          }
	            	            if(o=='gonghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ketangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ketangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
