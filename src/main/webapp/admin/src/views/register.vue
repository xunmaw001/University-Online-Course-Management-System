  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">高校网课管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="学院" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.xueyuan" autocomplete="off" placeholder="学院" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.kemu" class="input" type="text" placeholder="科目">
			   </div>
			 </div> -->
			<el-form-item label="科目" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.kemu" autocomplete="off" placeholder="科目" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.dianhua" autocomplete="off" placeholder="电话" type="text" />
																								...
																								<!-- <div v-if="tableName=='jiaowurenyuan'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='jiaowurenyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiaowurenyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaowurenyuan'" class="input-group">
			   <div class="label">姓名</div>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='jiaowurenyuan'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='jiaowurenyuan'" class="input-group">
			   <div class="label">学院</div>
			...
			<el-form-item label="学院" class="input" v-if="tableName=='jiaowurenyuan'">
			  <el-input v-model="ruleForm.xueyuan" autocomplete="off" placeholder="学院" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaowurenyuan'" class="input-group">
			   <div class="label">电话</div>
			...
			<el-form-item label="电话" class="input" v-if="tableName=='jiaowurenyuan'">
			  <el-input v-model="ruleForm.dianhua" autocomplete="off" placeholder="电话" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.zhanghao) && `jiaowurenyuan` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `jiaowurenyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                                                                                  if(`jiaowurenyuan` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
        this.$message.error(`电话应输入手机格式`);
        return
      }
                                                                                                                                                                                                                        this.$http({
